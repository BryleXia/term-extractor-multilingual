...
- **Keep the plural when the term is habitually plural.** Do not singularize
  `derechos humanos`, `fuerzas armadas`, `Naciones Unidas`, `Estados Unidos`, or
  a set formulation such as `nuevas fuerzas productivas de calidad`. If the
  concept only exists in the plural, the plural IS the dictionary form.
